...
export const localSearchPages = [
  {
    ...
    eyebrow: "Boys PG in Shamshabad",
    title: "Boys and Men's PG in Shamshabad, Hyderabad",
    seoTitle: "Boys & Men's PG in Shamshabad | Prince Deluxe PG",
    description:
      "Looking for a boys or men's PG in Shamshabad? Prince Deluxe PG offers furnished shared rooms, homely food, Wi-Fi, CCTV, lift access and attached washrooms.",
    intro:
      "Prince Deluxe PG For Boys provides furnished boys and men's paying guest accommodation in Brindavan Colony, Shamshabad for students, airport staff and working professionals.",
    heroImage: siteConfig.images.buildingDay,
    heroAlt: `${siteConfig.name} boys and men's PG building in Shamshabad`,
    distanceLabel: "Located in Brindavan Colony, Shamshabad",
    sectionTitle: "A practical men's PG for study, work and everyday living",
    sectionParagraphs: [
      ...
      "Students and working professionals can call or WhatsApp before visiting to confirm the current room category, monthly fee and availability.",
    ],
    benefits: [
      {
    ...
    faqs: [
      ...
      {
        question: "Is this a boys and men's PG in Shamshabad?",
        answer: "Yes. The accommodation is for male students, airport staff and working professionals.",
      },
      {
