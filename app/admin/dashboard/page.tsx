    ...
    <ProtectedAdminPage>
      <div className="grid gap-6">
        <div>
          ...
          <h1 className="font-heading text-3xl font-bold text-primary">Hostel overview</h1>
        </div>
        ...
        <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
          ...
          <AdminCard title="Occupancy" value={`${data.metrics.occupancyPercent}%`} />
          ...
          <AdminCard title="Available rooms" value={data.metrics.availableRooms} />
        </div>
