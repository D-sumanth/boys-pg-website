...
drop trigger if exists sync_room_capacity_slots_on_rooms on public.rooms;
create trigger sync_room_capacity_slots_on_rooms
after insert or update of capacity, room_type_id, room_number
on public.rooms
for each row
execute function public.sync_room_capacity_slots();
